...
document.addEventListener("DOMContentLoaded", (event) => {
  ...
  gsap
    ...
    .fromTo(
      ".shape_1",
      { scale: 0, rotate: "0deg" },
      { scale: 1, rotate: "360deg", duration: 0.8 }
    )
    // 둥실둥실
    .to(
      ".shape_1",
    ...
    // 7 -------------------------------
    .fromTo(".shape_7", { x: -1000 }, { x: 0, duration: 0.8 }, "-=1.33")
    .to(
      ".shape_7",
      {
        y: 10,
    ...
    // 8 -------------------------------
    .fromTo(".shape_8", { x: 500 }, { x: 0, duration: 0.8 }, "-=1.33")
    .to(
      ".shape_8",
      {
        y: 10,
    ...
    // 12 -------------------------------
    .fromTo(".shape_12", { x: -500 }, { x: 0, duration: 0.8 }, "-=0.8")
    .to(
      ".shape_12",
      {
        y: 10,
